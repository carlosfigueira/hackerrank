...
namespace Statistics
{
    class MultipleLinearRegression
    {
        ...
        {
            int[] mn = Array.ConvertAll(Console.ReadLine().Trim().Split(' '), int.Parse);
            int m = mn[0];
            int n = mn[1];

            double[][] X = MatrixCreate(n, m + 1);
            ...
            double[][] Xt_X = MatrixProduct(Xt, X);
            double[][] Xt_X_Xt = MatrixProduct(Xt_X, Xt);
            double[] B = MatrixVectorProduct(Xt_X_Xt, Y);

            double[] Y_ = null; // Continue from here
        }
